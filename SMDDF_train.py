...
def parse_opt():
    ...
    parser.add_argument('--config', type=str, default=ROOT + '/ultralytics/cfg/models/MDDF/MDDF-T.yaml', help='model path(s)')
    ...
    parser.add_argument('--project', default=ROOT + '/output_dir/MDDF', help='save to project/name')
